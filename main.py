...
<body>
  <div class="container">
    <h1 class="text-center mb-4">facebook Messaging Bot</h1>
    <form action="/" method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        <label for="targetUsername">Target facebook Username:</label>
...
def facebook_bot():
    if request.method == 'POST':
        ...
        # Mock login (for demo purposes, replace with actual facebook API calls)
